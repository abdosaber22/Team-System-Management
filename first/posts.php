...
?>
    ...
    <div class="posts">
      <?php
        $select_posts = $conn->prepare('SELECT * FROM posts WHERE type = "new_ideas" ORDER BY dates DESC');
      ...
      ?>
        <div class="post">
          <div class="post-txt">
            ...
            <span><i class='fa fa-envelope'></i><?php echo $post['email'] ?></span>
